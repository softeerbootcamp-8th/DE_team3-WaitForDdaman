...
### PYTHONPATH
Silver에는 자체 common/이 없어 src/common/(iceberg_catalog, iceberg_io 등)을
...
from dag_assets import STATION_ACTIVE_BRONZE, STATION_ACTIVE_SILVER
