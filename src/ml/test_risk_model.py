...
from ml.evaluate import apply_gate, select_best
from ml.features import FEATURE_COLS
from ml.samples import load_anchor_plan, resolve_anchors
from ml.settings import Config
...
def test_detect_label_ready_max_from_partitions(s3_env):
    ...
    from ml.samples import detect_label_ready_max
