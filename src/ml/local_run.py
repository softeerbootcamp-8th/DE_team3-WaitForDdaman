...
준비물
  ...
  - RISK_MODEL_CONFIG=<레포 경로>/src/config/risk_model.yaml
...
실행
  python -m ml.local_run
  python -m ml.local_run --as-of-end 2026-08-20 --dry-run
  python -m ml.local_run --skip-emr   # train_sample이 이미 S3에 있을 때
"""
...
def main() -> None:
    ...
    from ml.samples import detect_label_ready_max, resolve_anchors
