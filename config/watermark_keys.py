...
SILVER_STATION_MASTER = "_meta/watermark/silver_station_master.json"
SILVER_STATION_ACTIVE = "_meta/watermark/silver_station_active.json"
SILVER_BIKE_MAN_ACTION = "_meta/watermark/silver_bike_man_action.json"
